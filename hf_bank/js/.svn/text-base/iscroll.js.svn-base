(function () {
    ...
    var iScroll = function $iScroll$(el, options) {
        var that = this;
        var doc = document;
        var i;
    ...
    iScroll.prototype = {enabled: true, x: 0, y: 0, steps: [], scale: 1, currPageX: 0, currPageY: 0, pagesX: [], pagesY: [], aniTime: null, wheelZoomCount: 0, handleEvent: function $iScroll$$handleEvent$(e) {
        var that = this;
        switch (e.type) {
            case START_EV:
    ...
    }, _checkDOMChanges: function $iScroll$$_checkDOMChanges$() {
        ...
        this.refresh()
    }, _scrollbar: function $iScroll$$_scrollbar$(dir) {
        var that = this;
        var doc = document;
        var bar;
    ...
    }, _resize: function $iScroll$$_resize$() {
        var that = this;
        setTimeout(function () {
            that.refresh()
        }, isAndroid ? 200 : 0)
    }, _pos: function $iScroll$$_pos$(x, y) {
        x = this.hScroll ? x : 0;
        y = this.vScroll ? y : 0;
    ...
    }, _scrollbarPos: function $iScroll$$_scrollbarPos$(dir, hidden) {
        var that = this;
    ...
    }, _start: function $iScroll$$_start$(e) {
        var that = this;
    ...
    }, _move: function $iScroll$$_move$(e) {
        ...
        var duration = (e.timeStamp || Date.now()) - that.startTime;
        var newPosX = that.x;
        var newPosY = that.y;
        var distX;
        var distY;
        ...
        if (!that.moved) {
            ...
            } else that.doubleTapTimer = setTimeout(function () {
                that.doubleTapTimer = null;
                for (target = point.target; target.nodeType != 1;)target = target.parentNode;
        ...
        that._resetPos(200);
        if (that.options.onTouchEnd)that.options.onTouchEnd.call(that, e)
    }, _resetPos: function $iScroll$$_resetPos$(time) {
        var that = this;
        var resetX = that.x >= 0 ? 0 : that.x < that.maxScrollX ? that.maxScrollX : that.x;
        var resetY = that.y >= that.minScrollY || that.maxScrollY > 0 ? that.minScrollY : that.y < that.maxScrollY ? that.maxScrollY : that.y;
    ...
    }, _wheel: function $iScroll$$_wheel$(e) {
        var that = this;
        var wheelDeltaX;
        var wheelDeltaY;
        var deltaX;
    ...
    }, _mouseout: function $iScroll$$_mouseout$(e) {
        ...
        this._end(e)
    }, _transitionEnd: function $iScroll$$_transitionEnd$(e) {
        var that = this;
        if (e.target != that.scroller)return;
        that._unbind("webkitTransitionEnd");
        that._startAni()
    }, _startAni: function $iScroll$$_startAni$() {
        var that = this;
        var startX = that.x;
        var startY = that.y;
        ...
        animate()
    }, _transitionTime: function $iScroll$$_transitionTime$(time) {
        time += "ms";
        this.scroller.style[vendor + "TransitionDuration"] = time;
        if (this.hScrollbar)this.hScrollbarIndicator.style[vendor + "TransitionDuration"] = time;
        if (this.vScrollbar)this.vScrollbarIndicator.style[vendor + "TransitionDuration"] = time
    }, _momentum: function $iScroll$$_momentum$(dist, time, maxDistUpper, maxDistLower, size) {
        var deceleration = 6.0E-4;
    ...
    }, _offset: function $iScroll$$_offset$(el) {
        var left = -el.offsetLeft;
        for (var top = -el.offsetTop; el = el.offsetParent;) {
            left -= el.offsetLeft;
            top -= el.offsetTop
        }
        if (el != this.wrapper) {
    ...
    }, _snap: function $iScroll$$_snap$(x, y) {
        var that = this;
        var i;
        var l;
        var page;
    ...
    }, _bind: function $iScroll$$_bind$(type, el, bubble) {
        (el || this.scroller).addEventListener(type, this, !!bubble)
    },
        _unbind: function $iScroll$$_unbind$(type, el, bubble) {
        (el || this.scroller).removeEventListener(type, this, !!bubble)
    }, destroy: function $iScroll$$destroy$() {
        var that = this;
    ...
    }, refresh: function $iScroll$$refresh$() {
        var that = this;
        var offset;
        var i;
        var l;
        ...
        if (typeof that.options.snap == "string") {
            ...
            for (that.pagesX = []; pos >= that.maxScrollX;) {
            ...
            pos = 0;
            page = 0;
            for (that.pagesY = []; pos >= that.maxScrollY;) {
    ...
    }, scrollTo: function $iScroll$$scrollTo$(x, y, time, relative) {
        var that = this;
        var step = x;
        var i;
        var l;
        ...
        that._startAni()
    }, scrollToElement: function $iScroll$$scrollToElement$(el, time) {
        var that = this;
        var pos;
    ...
    }, scrollToPage: function $iScroll$$scrollToPage$(pageX, pageY, time) {
        var that = this;
        var x;
        var y;
    ...
    }, disable: function $iScroll$$disable$() {
        this.stop();
        this._resetPos(0);
        this.enabled = false;
    ...
    }, enable: function $iScroll$$enable$() {
        this.enabled = true
    }, stop: function $iScroll$$stop$() {
        if (this.options.useTransition)this._unbind("webkitTransitionEnd"); else cancelFrame(this.aniTime);
        this.steps = [];
        this.moved = false;
        this.animating = false
    }, zoom: function $iScroll$$zoom$(x, y, scale, time) {
        var that = this;
        ...
        that.zoomed = false
    }, isReady: function $iScroll$$isReady$() {
